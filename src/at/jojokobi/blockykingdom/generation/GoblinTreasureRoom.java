...
public class GoblinTreasureRoom extends Structure{
	...
	public GoblinTreasureRoom() {
		...
		loot.addItem(new LootItem(0.05, new ItemStack(Material.MUSIC_DISC_11), 1, 1));
		loot.addItem(new LootItem(0.05, new ItemStack(Material.MUSIC_DISC_13), 1, 1));
		loot.addItem(new LootItem(0.05, new ItemStack(Material.MUSIC_DISC_BLOCKS), 1, 1));
		loot.addItem(new LootItem(0.05, new ItemStack(Material.MUSIC_DISC_CAT), 1, 1));
