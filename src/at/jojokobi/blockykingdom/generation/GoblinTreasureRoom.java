...
public class GoblinTreasureRoom extends Structure{
	...
	public GoblinTreasureRoom() {
		...
		loot.addItem(new LootItem(0.1, new ItemStack(Material.GOLDEN_SWORD), 1, 1).setEnchant(true));
		loot.addItem(new LootItem(0.1, new ItemStack(Material.GOLDEN_AXE), 1, 1).setEnchant(true));
		loot.addItem(new LootItem(0.1, new ItemStack(Material.GOLDEN_PICKAXE), 1, 1).setEnchant(true));
		loot.addItem(new LootItem(0.1, new ItemStack(Material.NAME_TAG), 1, 1));
		loot.addItem(new LootItem(0.02, new ItemStack(Material.MUSIC_DISC_11), 1, 1));
		loot.addItem(new LootItem(0.02, new ItemStack(Material.MUSIC_DISC_13), 1, 1));
		loot.addItem(new LootItem(0.02, new ItemStack(Material.MUSIC_DISC_BLOCKS), 1, 1));
		loot.addItem(new LootItem(0.02, new ItemStack(Material.MUSIC_DISC_CAT), 1, 1));
		loot.addItem(new LootItem(0.05, new ItemStack(Material.GOLDEN_APPLE), 1, 1));
		loot.addItem(new LootItem(0.02, new ItemStack(Material.ENCHANTED_GOLDEN_APPLE), 1, 1));
		loot.addItem(new LootItem(0.05, new ItemStack(Material.ENCHANTED_BOOK), 1, 1).setEnchant(true));
		loot.addItem(new LootItem(0.05, new ItemStack(Material.ENCHANTED_BOOK), 1, 1).setEnchant(true));
		loot.addItem(new LootItem(0.05, new ItemStack(Material.ENCHANTED_BOOK), 1, 1).setEnchant(true));
